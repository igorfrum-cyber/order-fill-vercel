...
- опциональное объединение остатков, товаров в пути и продаж из второго склада
  Тюмени до расчёта обычного заказа;
...
- перерасчёт количества под целевую сумму с выбором, включена ли скидка в цену;
  введённая скидка влияет только на подбор количества и не меняет цены в Excel;
