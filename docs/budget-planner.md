...
Особые правила CHRISTINA PROFF описаны в [Комплекты PROFF](christina-lines.md): скидка только на равные комплекты, отдельный этап добора и исключение первых трех комплектов без истории продаж. В HOME и PROFF экспорт сохраняет клубные цены; изложенная ниже выгрузка закупочной скидки относится к остальным брендам.
