...
В разделе «Бланк» под выбором бренда включить «Тюмень: 2 склада». Та же ячейка становится загрузкой «СКЛАД ДОСТАВКА», галочка остаётся доступной. Загрузить таблицу офиса, таблицу склада и бланк поставщика. При снятии галочки файл второго склада очищается и больше не требуется. Для остальных городов переключатель выключен, прежний порядок сохраняется.
...
Если в отчёте нового «СКЛАДА ДОСТАВКА» ещё нет месячных колонок продаж, его месячные продажи считаются нулевыми. Объединение ЧЗ, остатки и товар в пути учитываются как обычно. Шаблон, месяцы, период и срок поставки общего отчёта берутся из таблицы офиса. Если при отсутствии месяцев у склада уже указаны ненулевые итоговые продажи или выручка, требуется отчёт с месячной разбивкой: такие продажи нельзя молча обнулить. Для отчёта офиса месячные колонки по-прежнему обязательны.
