    ...
    return [
      {
        ...
        placement: "bottom",
        title: "Готовые файлы",
        body: "Количество можно править в бланке или в «Заказано по факту». Это одно число; суммы в бланке пересчитаются сами.",
      },
      {
  ...
  if (role === "platform_admin") {
    return [
      ...
      },
      {
        ...
        placement: "top",
        title: "Выгрузки",
        body: "На обзоре видно, что сейчас считается. Новую выгрузку создаёт закупщик, владелец или администратор компании.",
      },
      {
        target: "help",
        placement: "bottom",
...
export const helpSections = [
  ...
  {
    title: "Что значит «Требует решения»",
    body: "Это спорные пары: дубли или найдено только по названию. Отметьте «оставляю» на каждой строке, иначе файлы не откроются.",
  },
  {
